            ...
            <form id="enquiry-form" action="{{ route('front.contact.store') }}" method="POST">
                ...
                <div class="mb-2 form-group">
                    ...
                    <div class="flex">
                        ...
                        <input type="text" name="name" class="bg-white" placeholder="Name" required>
                    </div>
                </div>
                <div class="mb-2 form-group">
                    ...
                    <div class="flex">
                        ...
                        <input type="email" name="email" class="bg-white" placeholder="Email">
                    </div>
                </div>
                <div class="mb-2 form-group">
                    ...
                    <div class="flex">
                        ...
                        <input type="text" name="country" id="" class="bg-white" list="countries" placeholder="Country">
                    </div>
                </div>
                <div class="mb-2 form-group">
                    ...
                    <div class="flex">
                        ...
                        <input type="tel" name="phone" class="bg-white" placeholder="Phone No.">
                    </div>
                </div>
                <div class="mb-2 form-group">
