...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['web', 'admin']], function ()
{
	...
	Route::get('trips/slider/{sliderId}/edit', 'TripController@editSlider')->name('trips.slider.edit');
	Route::post('trips/slider/update', 'TripController@updateSlider')->name('trips.slider.update');
